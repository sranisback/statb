...
class SponsorSupprimeTest  extends TestCase
{
    /**
     * @test
     */
    public function le_text_s_affiche_bien()
    {
        ...
        $messageActual = $infosServiceTest->sponsorSupprime($equipeMock);

        $this->assertEquals('TEST SPONSOR a décidé de ne plus sponsoriser <a href="/team/1">test team</a> !',  $messageActual->getMessages());
    }
